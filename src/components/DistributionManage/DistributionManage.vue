<template>
	<div>
		...
		<el-card class="box-card">
			...
			<el-table :data="pageList" border stripe style="width: 100%;margin-top: 8px;" :row-style="{height:'60px'}" :cell-style="{padding:'0px'}" :header-cell-style="{background:'#f8f8f9', color:'#000000'}">
		...
		<el-form v-if="showApproved" :model="approvedForm" ref="approvedFormRef" label-width="100px">
			...
			<el-form-item label="回单附件:" prop="returnpicture">
				...
				<el-upload name="imgFile" :action="updateReturnUrl" :auto-upload="true" :on-success="handleReturnSuccess" :show-file-list="false">
